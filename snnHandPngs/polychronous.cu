...
int main() {
	...
	/*inputNeuronVec.push_back(inputNeur[3]);
	 inputNeuronVec.push_back(inputNeur[4]);
	 inputNeuronVec.push_back(inputNeur[5]);*/
	inputTimeVec.push_back(0);
	inputTimeVec.push_back(inputTime[1]);
	inputTimeVec.push_back(inputTime[2]);
	/*inputTimeVec.push_back(inputTime[3]);
	 inputTimeVec.push_back(inputTime[4]);
	 inputTimeVec.push_back(inputTime[5]);*/
